...
___
## 復習問題
- ここまでのスライドを見ずに(ヒントなしで), `Hello, Perl Entrance!`という文字列を出力する`hello_perl.pl`を書いて下さい
    - どうしても思い出せない...! という所があれば, ここまでのスライドや, 前回(第1回)のスライドを見ながら書いてみましょう
